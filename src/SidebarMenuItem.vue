<template>
  ...
  >
    <li
      ...
      :key="subItem.uID"
      :class="['nav-item', subItem.children?.length ? 'nav-dropdown' : '']"
...
function selectNavDropdown(item){
	  let selected_nav_item = document.getElementById('nav_item_'+item.unique_id);
